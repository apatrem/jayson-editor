...
[ADR-0020](adr/0020-json-docmodel-supersedes-yaml.md)) and **D-15** (initial doc
...
Markdoc/MDX, already rejected — see ADR-0020) *and* still degrading on the
...
- **D-18** → [ADR-0020](adr/0020-json-docmodel-supersedes-yaml.md): JSON DocModel
