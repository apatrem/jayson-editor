...
- Review note (not acceptance): capability/ACL additions, if any, must be reviewed against the actual plugin source — AGENTS.md review playbook applies

## Meta
- mode: low
- risk: low
- depends-on: []
- blocked-by: PR #6 merge (D-41 decision text in docs/DECISIONS.md)
